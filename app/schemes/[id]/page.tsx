...
import { ArrowLeft, Page, CheckCircle, HelpCircle, Brain } from "iconoir-react"
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        >
                            <h2 className="text-2xl font-bold text-slate-900 mb-6 flex items-center">
                                <Page className="h-6 w-6 text-amber-600 mr-3" />
                                {t.overview}
                            </h2>
                        ...
                        >
                            ...
                            <ul className="space-y-3">
                                {content.full_page_content.eligibility_detailed.map((item, i) => (
                                    <li key={i} className="flex items-start">
                                        <CheckCircle className="h-5 w-5 text-slate-400 mr-3 shrink-0" />
